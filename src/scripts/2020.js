...
const worksData = [
  ...
  },
  {
    ...
    // cover: '../../src/assets/img/original/My Trip.png',
    cover:'../../assets/images/original/My_Trip.png',
    // info: '/projects/ghibli-crawler',
    link: 'https://mytrip-rho-lemon.vercel.app/',
  },
  {
...
class Portfolio {
  ...
  submitForm(e) {
    ...
    setTimeout(() => {
      const receiver = 'amitcse060@gmail.com';
